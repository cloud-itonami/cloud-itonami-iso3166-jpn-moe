...
`cloud-itonami-iso3166-jpn-moe` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
- the advisor cannot directly submit a filing/registration or commit a
  public record.
- the Environmental Compliance Governor remains independent of the advisor.
...
representation Japanese law requires for MOE filings.
