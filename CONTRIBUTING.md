...
`cloud-itonami-iso3166-jpn-moe` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Environmental Compliance Governor.
- Never let the advisor state a legal/tax conclusion as fact — every
  regulatory requirement must cite the official MOE source.
